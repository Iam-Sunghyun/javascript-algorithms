 ...
 * 한 포인터는 한방향으로 이동하고 다른 포인터는 양방향으로 이동해가는 방식 등이 있다
 * 공간복잡도도 효율적이다(따로 공간 사용 no)
 * 
...
// 두 포인터가 양 끝 지점에서 시작하여 중앙쪽으로 이동하며 값 쌍을 찾아낸다
// 1번의 반복으로 원하는 값 쌍을 찾아낸다
